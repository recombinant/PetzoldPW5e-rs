...
use winapi::um::winuser::{CreateWindowExW, DefWindowProcW, PostQuitMessage, RegisterClassExW,
                          ...
                          GetClientRect, SetTimer, MessageBeep, FillRect, GetDC, ReleaseDC,
                          MSG, WNDCLASSEXW, WM_CREATE, WM_DESTROY, WS_OVERLAPPEDWINDOW,
                          SW_SHOW, CS_HREDRAW,
...
unsafe extern "system" fn timer_proc(hwnd: HWND,
                                     _message: UINT,
                                     _event_id: UINT_PTR,
                                     _time: DWORD) {
    ...
    let hbrush: HBRUSH = CreateSolidBrush(if FLIP_FLOP {RGB(255, 0, 0)} else { RGB(0, 0, 255)});
