...
use winapi::um::winuser::{
    ...
    ReleaseDC, SetCursor, ShowWindow, TranslateMessage, UpdateWindow, CS_HREDRAW, CS_VREDRAW,
    CW_USEDEFAULT, IDC_ARROW, IDC_CROSS, IDI_APPLICATION, MB_ICONERROR, MSG, PAINTSTRUCT, SW_SHOW,
    WM_CHAR, WM_DESTROY, WM_LBUTTONDOWN, WM_LBUTTONUP, WM_MOUSEMOVE, WM_PAINT, WNDCLASSEXW,
    WS_OVERLAPPEDWINDOW,
};
...
fn main() {
    ...
    unsafe {
        ...
        let caption = to_wstr("Mouse Button Demo");
