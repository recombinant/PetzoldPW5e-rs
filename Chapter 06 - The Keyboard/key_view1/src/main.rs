...
use winapi::um::wingdi::{GetTextMetricsW, SetBkMode, TextOutW, TEXTMETRICW};
use winapi::um::winuser::{
    ...
    MessageBoxW, PostQuitMessage, RegisterClassExW, ReleaseDC, ScrollWindowEx, ShowWindow,
    TranslateMessage, UpdateWindow, CS_HREDRAW, CS_VREDRAW, CW_USEDEFAULT, IDC_ARROW,
    IDI_APPLICATION, MB_ICONERROR, MSG, PAINTSTRUCT, SM_CXMAXIMIZED, SM_CYMAXIMIZED, SW_ERASE,
    SW_INVALIDATE, SW_SHOW, WM_CHAR, WM_CREATE, WM_DEADCHAR, WM_DESTROY, WM_DISPLAYCHANGE,
    WM_KEYDOWN, WM_KEYFIRST, WM_KEYUP, WM_PAINT, WM_SIZE, WM_SYSCHAR, WM_SYSDEADCHAR,
